  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white !important; margin: unset !important; padding: unset !important;><span aria-hidden="true">&times;</span></button>' +
        ...
        '<form method="post"' +
        '<button type="button" class="btn btn-primary ' + classCheckoutCart + '">Checkout with PayPal</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><img width="45px" height="45px" src="' + this.image + '"/></td>' +
          '<td>' + this.name + '</td>' +
